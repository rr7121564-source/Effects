...
.method static constructor <clinit>()V
    ...
    sget-object v40, Lcom/google/mlkit/vision/text/latin/cIgy/LsoBKOuSwGZBt;->fLRvb:Ljava/lang/String;
...
.method public static synthetic a(Lcom/google/common/util/concurrent/t;Ljava/lang/Runnable;Ljava/lang/Object;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/media3/common/util/Util;->lambda$postOrRunWithCompletion$0(Lcom/google/common/util/concurrent/t;Ljava/lang/Runnable;Ljava/lang/Object;)V
...
.method public static synthetic b(Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/m;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/media3/common/util/Util;->lambda$transformFutureAsync$1(Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/m;)V
...
.method public static synthetic c(Lcom/google/common/util/concurrent/m;Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/c;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/media3/common/util/Util;->lambda$transformFutureAsync$2(Lcom/google/common/util/concurrent/m;Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/c;)V
...
.method public static varargs checkCleartextTrafficPermitted([Landroidx/media3/common/MediaItem;)Z
    ...
    iget-object v6, v6, Landroidx/media3/common/MediaItem$LocalConfiguration;->subtitleConfigurations:Lcom/google/common/collect/y;
...
.method public static contentEquals(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-static {p0, p1}, Landroidx/media3/common/util/o;->a(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
...
.method public static contentHashCode(Landroid/util/SparseArray;)I
    ...
    invoke-static {p0}, Landroidx/media3/common/util/k;->a(Landroid/util/SparseArray;)I
...
.method public static fromUtf8Bytes([B)Ljava/lang/String;
    ...
    sget-object v1, Lp3/e;->c:Ljava/nio/charset/Charset;
...
.method public static getCountryCode(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lokhttp3/Jcw/TJzsVg;->mshGlUs:Ljava/lang/String;
    ...
    invoke-static {p0}, Lp3/c;->f(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getDefaultDisplayLocale()Ljava/util/Locale;
    ...
    invoke-static {}, Landroidx/media3/common/util/m;->a()Ljava/util/Locale$Category;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/common/util/n;->a(Ljava/util/Locale$Category;)Ljava/util/Locale;
...
.method public static getDrmUuid(Ljava/lang/String;)Ljava/util/UUID;
    ...
    invoke-static {p0}, Lp3/c;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getFormatSupportString(I)Ljava/lang/String;
    ...
    sget-object p0, Le6/aw/vYszgCS;->cJbm:Ljava/lang/String;
...
.method public static getRoleFlagStrings(I)Ljava/util/List;
    ...
    sget-object p0, Landroidx/interpolator/zu/HCcdzjTTVDNkK;->gxwOZkMIpoeH:Ljava/lang/String;
...
.method public static getUtf8Bytes(Ljava/lang/String;)[B
    ...
    sget-object v0, Lp3/e;->c:Ljava/nio/charset/Charset;
...
.method public static inferContentType(Landroid/net/Uri;)I
    ...
    invoke-static {v1, v0}, Lp3/c;->a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method public static isBitmapFactorySupportedMimeType(Ljava/lang/String;)Z
    ...
    sget-object v3, Lm7/gklX/XPveoVzZ;->rMsDYH:Ljava/lang/String;
    ...
    sget-object v3, Le6/aw/vYszgCS;->lLdBCTjrbI:Ljava/lang/String;
...
.method public static isFrameDropAllowedOnSurfaceInput(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, Lp3/c;->a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method public static isRunningOnEmulator()Z
    ...
    invoke-static {v0}, Lp3/c;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method private static synthetic lambda$postOrRunWithCompletion$0(Lcom/google/common/util/concurrent/t;Ljava/lang/Runnable;Ljava/lang/Object;)V
    .locals 1

    :try_start_0
    invoke-virtual {p0}, Lcom/google/common/util/concurrent/t;->isCancelled()Z
    ...
    invoke-virtual {p0, p2}, Lcom/google/common/util/concurrent/t;->A(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/util/concurrent/t;->B(Ljava/lang/Throwable;)Z

    :goto_0
    return-void
.end method

.method private static synthetic lambda$transformFutureAsync$1(Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/m;)V
    .locals 0
...
.method private static synthetic lambda$transformFutureAsync$2(Lcom/google/common/util/concurrent/m;Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/c;)V
    .locals 0

    :try_start_0
    invoke-static {p0}, Lcom/google/common/util/concurrent/i;->b(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    :try_start_1
    invoke-interface {p2, p0}, Lcom/google/common/util/concurrent/c;->apply(Ljava/lang/Object;)Lcom/google/common/util/concurrent/m;

    move-result-object p0

    invoke-virtual {p1, p0}, Lcom/google/common/util/concurrent/t;->C(Lcom/google/common/util/concurrent/m;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {p1, p0}, Lcom/google/common/util/concurrent/t;->B(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p1, p0}, Lcom/google/common/util/concurrent/t;->cancel(Z)Z
...
.method public static varargs maybeRequestReadStoragePermission(Landroid/app/Activity;[Landroidx/media3/common/MediaItem;)Z
    ...
    iget-object v3, v3, Landroidx/media3/common/MediaItem$LocalConfiguration;->subtitleConfigurations:Lcom/google/common/collect/y;
...
.method public static newSingleThreadExecutor(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v0, p0}, Landroidx/media3/common/util/v;-><init>(Ljava/lang/String;)V
...
.method public static newSingleThreadScheduledExecutor(Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v0, p0}, Landroidx/media3/common/util/s;-><init>(Ljava/lang/String;)V
...
.method public static normalizeLanguageCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Ll5/CRu/gqCjhhADYArReC;->LmIKRcBjMy:Ljava/lang/String;
...
.method public static postOrRunWithCompletion(Landroid/os/Handler;Ljava/lang/Runnable;Ljava/lang/Object;)Lcom/google/common/util/concurrent/m;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {}, Lcom/google/common/util/concurrent/t;->E()Lcom/google/common/util/concurrent/t;

    move-result-object v0

    new-instance v1, Landroidx/media3/common/util/r;

    invoke-direct {v1, v0, p1, p2}, Landroidx/media3/common/util/r;-><init>(Lcom/google/common/util/concurrent/t;Ljava/lang/Runnable;Ljava/lang/Object;)V
...
.method public static scaleLargeValue(JJJLjava/math/RoundingMode;)J
    ...
    invoke-static {p4, p5, p2, p3, v0}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide p2

    invoke-static {p0, p1, p2, p3, p6}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {p2, p3, p4, p5, p6}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide p2

    invoke-static {p0, p1, p2, p3}, Lq3/d;->c(JJ)J
    ...
    invoke-static {p4, p5, p0, p1, v0}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide p0

    invoke-static {p2, p3, p0, p1, p6}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {p0, p1, p4, p5, p6}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide p0

    invoke-static {p2, p3, p0, p1}, Lq3/d;->c(JJ)J
...
.method private static scaleLargeValueFallback(JJJLjava/math/RoundingMode;)J
    ...
    invoke-static {v0, v1, p4, p5, p6}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {v0, v1, v7, v8}, Lq3/d;->b(JJ)J

    move-result-wide v0

    sget-object v4, Ljava/math/RoundingMode;->UNNECESSARY:Ljava/math/RoundingMode;

    invoke-static {p2, p3, v0, v1, v4}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide p2

    invoke-static {p4, p5, v0, v1, v4}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {p0, p1, v0, v1, v4}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    :cond_3
    invoke-static {p0, p1, p6}, Lq3/a;->c(DLjava/math/RoundingMode;)J
...
.method public static scaleLargeValues(Ljava/util/List;JJLjava/math/RoundingMode;)[J
    ...
    invoke-static {v10, v11, v8, v9, v1}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {v5, v6, v3, v4, v12}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {v8, v9, v10, v11, v1}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {v5, v6, v3, v4}, Lq3/d;->c(JJ)J
    ...
    invoke-static {v10, v11, v1, v2, v3}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide v1

    invoke-static {v8, v9, v1, v2, v12}, Lq3/d;->a(JJLjava/math/RoundingMode;)J
    ...
    invoke-static {v1, v2, v10, v11, v3}, Lq3/d;->a(JJLjava/math/RoundingMode;)J

    move-result-wide v1

    invoke-static {v8, v9, v1, v2}, Lq3/d;->c(JJ)J
...
.method public static startForegroundService(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    invoke-static {p0, p1}, Landroidx/media3/common/util/q;->a(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public static transformFutureAsync(Lcom/google/common/util/concurrent/m;Lcom/google/common/util/concurrent/c;)Lcom/google/common/util/concurrent/m;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, v0, p0}, Landroidx/media3/common/util/t;-><init>(Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/m;)V

    invoke-static {}, Lcom/google/common/util/concurrent/p;->a()Ljava/util/concurrent/Executor;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/google/common/util/concurrent/t;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    new-instance v1, Landroidx/media3/common/util/u;

    invoke-direct {v1, p0, v0, p1}, Landroidx/media3/common/util/u;-><init>(Lcom/google/common/util/concurrent/m;Lcom/google/common/util/concurrent/t;Lcom/google/common/util/concurrent/c;)V
