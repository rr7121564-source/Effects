...
.field mSurfaceReleaseFuture:Lcom/google/common/util/concurrent/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static synthetic a(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic b(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;Lcom/google/common/util/concurrent/m;Landroidx/camera/core/SurfaceRequest;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/camera/view/TextureViewImplementation;->lambda$tryToProvidePreviewSurface$2(Landroid/view/Surface;Lcom/google/common/util/concurrent/m;Landroidx/camera/core/SurfaceRequest;)V

    return-void
.end method

.method public static synthetic c(Landroidx/camera/view/TextureViewImplementation;Landroidx/camera/core/SurfaceRequest;)V
    .locals 0
...
.method public static synthetic d(Landroidx/camera/view/TextureViewImplementation;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method private synthetic lambda$onSurfaceRequested$0(Landroidx/camera/core/SurfaceRequest;)V
    ...
    iput-object p1, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lcom/google/common/util/concurrent/m;
...
.method private synthetic lambda$tryToProvidePreviewSurface$1(Landroid/view/Surface;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/gson/internal/bind/Iknm/FcQBNlLZDFp;->QXzHK:Ljava/lang/String;
    ...
    new-instance v2, Landroidx/camera/view/h0;

    invoke-direct {v2, p2}, Landroidx/camera/view/h0;-><init>(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$tryToProvidePreviewSurface$2(Landroid/view/Surface;Lcom/google/common/util/concurrent/m;Landroidx/camera/core/SurfaceRequest;)V
    .locals 2
    ...
    iget-object p1, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lcom/google/common/util/concurrent/m;

    const/4 v0, 0x0

    if-ne p1, p2, :cond_0

    iput-object v0, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lcom/google/common/util/concurrent/m;
...
.method onSurfaceRequested(Landroidx/camera/core/SurfaceRequest;Landroidx/camera/view/PreviewViewImplementation$OnSurfaceNotInUseListener;)V
    ...
    new-instance v0, Landroidx/camera/view/g0;

    invoke-direct {v0, p0, p1}, Landroidx/camera/view/g0;-><init>(Landroidx/camera/view/TextureViewImplementation;Landroidx/camera/core/SurfaceRequest;)V
...
.method tryToProvidePreviewSurface()V
    ...
    new-instance v2, Landroidx/camera/view/i0;

    invoke-direct {v2, p0, v0}, Landroidx/camera/view/i0;-><init>(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;)V
    ...
    iput-object v2, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lcom/google/common/util/concurrent/m;

    new-instance v3, Landroidx/camera/view/j0;

    invoke-direct {v3, p0, v0, v2, v1}, Landroidx/camera/view/j0;-><init>(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;Lcom/google/common/util/concurrent/m;Landroidx/camera/core/SurfaceRequest;)V
...
.method waitForNextFrame()Lcom/google/common/util/concurrent/m;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v0, p0}, Landroidx/camera/view/f0;-><init>(Landroidx/camera/view/TextureViewImplementation;)V
