...
.method public k(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p3}, Li2/v;->b(Landroid/app/Activity;Landroid/content/Intent;I)Li2/v;
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/google/android/gms/common/a;->p(Landroid/content/Context;ILi2/v;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method final p(Landroid/content/Context;ILi2/v;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p1, p2}, Li2/s;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Li2/s;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1, p2}, Li2/s;->f(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final q(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Li2/s;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(Landroid/content/Context;Lg2/p;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    ...
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabx;-><init>(Lg2/p;)V

    invoke-static {p1, v1, v0}, Lv2/g;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method final s(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p2, p4}, Le2/e;->l(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Le2/e;

    move-result-object p2

    invoke-virtual {p2, p1, p3}, Le2/e;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
...
.method final t(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    sget-object p3, Lcom/google/mlkit/vision/text/pipeline/TnP/XoBDa;->Mtam:Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p1, p2}, Li2/s;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p2}, Li2/s;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lp2/i;->f(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_4

    invoke-static {}, Lp2/o;->e()Z
    ...
    invoke-static {p1}, Lp2/i;->g(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_3

    sget v1, Ld2/a;->common_full_open_on_phone:I

    sget v6, Ld2/b;->common_open_on_phone:I
    ...
    sget v7, Ld2/b;->common_google_play_services_notification_ticker:I
    ...
    sget v4, Ld2/b;->common_google_play_services_notification_channel_name:I
    ...
    :cond_6
    invoke-static {p4}, Le2/b;->a(Landroid/app/NotificationChannel;)Ljava/lang/CharSequence;
    ...
    invoke-static {p4, p1}, Le2/c;->a(Landroid/app/NotificationChannel;Ljava/lang/CharSequence;)V
...
.method public final v(Landroid/app/Activity;Lg2/e;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 7
    ...
    invoke-static {p2, p4, v0}, Li2/v;->c(Lg2/e;Landroid/content/Intent;I)Li2/v;
...
.method public final w(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-static {p1}, Lq2/b;->a(Landroid/content/Context;)Z
