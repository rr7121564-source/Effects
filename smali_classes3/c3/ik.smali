...
# virtual methods
.method public final H(Lr2/a;)Lc3/hk;
    .locals 3
    ...
    :cond_1
    new-instance v1, Lc3/hk;

    invoke-direct {v1, v0}, Lc3/hk;-><init>(Landroid/os/IBinder;)V
...
.method public final m4(Lr2/a;Lcom/google/android/gms/internal/mlkit_vision_text_common/zzvh;)Lc3/hk;
    .locals 2
    ...
    instance-of v1, v0, Lc3/hk;

    if-eqz v1, :cond_1

    move-object p2, v0

    check-cast p2, Lc3/hk;

    goto :goto_0

    :cond_1
    new-instance v0, Lc3/hk;

    invoke-direct {v0, p2}, Lc3/hk;-><init>(Landroid/os/IBinder;)V
