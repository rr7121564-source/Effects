...
.method public constructor <init>(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;Ljava/util/List;Landroidx/core/util/Pools$Pool;)V
    ...
    iput-object p5, p0, Lcom/bumptech/glide/load/engine/p;->b:Landroidx/core/util/Pools$Pool;

    invoke-static {p4}, Lk0/h;->c(Ljava/util/Collection;)Ljava/util/Collection;
...
.method private b(Ln/d;Lm/g;IILcom/bumptech/glide/load/engine/h$a;Ljava/util/List;)Lp/c;
    .locals 12
    ...
    :try_start_0
    invoke-virtual/range {v6 .. v11}, Lcom/bumptech/glide/load/engine/h;->a(Ln/d;IILm/g;Lcom/bumptech/glide/load/engine/h$a;)Lp/c;
...
# virtual methods
.method public a(Ln/d;Lm/g;IILcom/bumptech/glide/load/engine/h$a;)Lp/c;
    .locals 8

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/p;->b:Landroidx/core/util/Pools$Pool;
    ...
    :try_start_0
    invoke-direct/range {v1 .. v7}, Lcom/bumptech/glide/load/engine/p;->b(Ln/d;Lm/g;IILcom/bumptech/glide/load/engine/h$a;Ljava/util/List;)Lp/c;

    move-result-object p1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p2, p0, Lcom/bumptech/glide/load/engine/p;->b:Landroidx/core/util/Pools$Pool;
