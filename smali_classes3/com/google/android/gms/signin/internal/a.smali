...
.field private final Z:Li2/c;

.field private final a0:Landroid/os/Bundle;

.field private final b0:Ljava/lang/Integer;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLi2/c;Landroid/os/Bundle;Lcom/google/android/gms/common/api/c$a;Lcom/google/android/gms/common/api/c$b;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/gms/common/internal/c;-><init>(Landroid/content/Context;Landroid/os/Looper;ILi2/c;Lcom/google/android/gms/common/api/c$a;Lcom/google/android/gms/common/api/c$b;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/google/android/gms/signin/internal/a;->Y:Z

    iput-object p4, p0, Lcom/google/android/gms/signin/internal/a;->Z:Li2/c;

    iput-object p5, p0, Lcom/google/android/gms/signin/internal/a;->a0:Landroid/os/Bundle;

    invoke-virtual {p4}, Li2/c;->g()Ljava/lang/Integer;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/gms/signin/internal/a;->b0:Ljava/lang/Integer;

    return-void
.end method

.method public static l0(Li2/c;)Landroid/os/Bundle;
    .locals 4

    invoke-virtual {p0}, Li2/c;->f()Lh3/a;

    invoke-virtual {p0}, Li2/c;->g()Ljava/lang/Integer;
    ...
    invoke-virtual {p0}, Li2/c;->a()Landroid/accounts/Account;
...
.method protected final A()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/google/android/gms/signin/internal/a;->Z:Li2/c;

    invoke-virtual {v0}, Li2/c;->d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/signin/internal/a;->a0:Landroid/os/Bundle;

    iget-object v1, p0, Lcom/google/android/gms/signin/internal/a;->Z:Li2/c;

    const-string v2, "com.google.android.gms.signin.internal.realClientPackageName"

    invoke-virtual {v1}, Li2/c;->d()Ljava/lang/String;
...
.method public final m(Li3/c;)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/android/gms/signin/internal/a;->Z:Li2/c;

    invoke-virtual {v2}, Li2/c;->b()Landroid/accounts/Account;
    ...
    invoke-static {v3}, Lc2/b;->a(Landroid/content/Context;)Lc2/b;

    move-result-object v3

    invoke-virtual {v3}, Lc2/b;->b()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    iget-object v5, p0, Lcom/google/android/gms/signin/internal/a;->b0:Ljava/lang/Integer;
    ...
    invoke-virtual {v2, v3, p1}, Lcom/google/android/gms/signin/internal/c;->U2(Lcom/google/android/gms/signin/internal/zai;Li3/c;)V
    :try_end_0
    ...
    invoke-interface {p1, v3}, Li3/c;->a1(Lcom/google/android/gms/signin/internal/zak;)V
    :try_end_1
