...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lu2/l;->b:Z

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadScheduledExecutor()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    iput-object v1, p0, Lu2/l;->c:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    iput-object v0, p0, Lu2/l;->d:Ljava/util/concurrent/ExecutorService;

    iput-object p1, p0, Lu2/l;->a:Landroid/content/Context;

    iget-boolean p1, p0, Lu2/l;->b:Z
    ...
    invoke-direct {v2, p0, p1}, Lu2/j;-><init>(Lu2/l;Lu2/i;)V
    ...
    iput-boolean p1, p0, Lu2/l;->b:Z

    :cond_0
    return-void
.end method

.method static bridge synthetic b(Lu2/l;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lu2/l;->a:Landroid/content/Context;

    return-object p0
.end method

.method static declared-synchronized c(Landroid/content/Context;)La2/b;
    .locals 2
    ...
    invoke-static {p0, v1}, Li2/i;->m(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lu2/l;->e:La2/b;
    ...
    invoke-direct {v1, p0}, Lu2/l;-><init>(Landroid/content/Context;)V

    sput-object v1, Lu2/l;->e:La2/b;
...
.method protected static final f(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lu2/l;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method private static final h(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0}, Lu2/k;-><init>(Ljava/lang/String;)V
...
.method protected final a()J
    ...
    invoke-static {v0}, Lu2/l;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public final d()Lj3/j;
    ...
    iget-object v1, p0, Lu2/l;->d:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lu2/h;

    invoke-direct {v2, p0, v0}, Lu2/h;-><init>(Lu2/l;Lj3/k;)V
...
.method final synthetic e(Lj3/k;)V
    .locals 7
    ...
    invoke-static {v1}, Lu2/l;->h(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-virtual {p1, v0}, Lj3/k;->b(Ljava/lang/Exception;)V
    ...
    invoke-static {v1}, Lu2/l;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    move-result v2
    :try_end_1
    .catch Lu2/k; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-direct {v1, v0, v2}, La2/c;-><init>(Ljava/lang/String;I)V

    invoke-virtual {p1, v1}, Lj3/k;->c(Ljava/lang/Object;)V
