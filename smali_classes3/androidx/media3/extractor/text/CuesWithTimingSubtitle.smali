...
# static fields
.field private static final CUES_BY_START_TIME_ASCENDING:Lcom/google/common/collect/s0;
...
# instance fields
.field private final eventCues:Lcom/google/common/collect/y;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v1}, Lcom/google/common/collect/s0;->f(Lp3/g;)Lcom/google/common/collect/s0;

    move-result-object v0

    sput-object v0, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->CUES_BY_START_TIME_ASCENDING:Lcom/google/common/collect/s0;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/common/collect/g0;->g(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    iget-object v1, v3, Landroidx/media3/extractor/text/CuesWithTiming;->cues:Lcom/google/common/collect/y;

    invoke-static {v1}, Lcom/google/common/collect/y;->E(Ljava/lang/Object;)Lcom/google/common/collect/y;

    move-result-object v1

    iput-object v1, v0, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->eventCues:Lcom/google/common/collect/y;
    ...
    :cond_0
    iget-object v5, v3, Landroidx/media3/extractor/text/CuesWithTiming;->cues:Lcom/google/common/collect/y;

    invoke-static {}, Lcom/google/common/collect/y;->D()Lcom/google/common/collect/y;

    move-result-object v6

    invoke-static {v5, v6}, Lcom/google/common/collect/y;->G(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/y;

    move-result-object v5

    iput-object v5, v0, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->eventCues:Lcom/google/common/collect/y;
    ...
    sget-object v3, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->CUES_BY_START_TIME_ASCENDING:Lcom/google/common/collect/s0;

    move-object/from16 v7, p1

    invoke-static {v3, v7}, Lcom/google/common/collect/y;->M(Ljava/util/Comparator;Ljava/lang/Iterable;)Lcom/google/common/collect/y;
    ...
    iget-object v9, v8, Landroidx/media3/extractor/text/CuesWithTiming;->cues:Lcom/google/common/collect/y;
    ...
    iget-object v7, v8, Landroidx/media3/extractor/text/CuesWithTiming;->cues:Lcom/google/common/collect/y;
    ...
    :cond_6
    invoke-static {v1}, Lcom/google/common/collect/y;->x(Ljava/util/Collection;)Lcom/google/common/collect/y;
...
# virtual methods
.method public getCues(J)Lcom/google/common/collect/y;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    :cond_0
    iget-object p2, p0, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->eventCues:Lcom/google/common/collect/y;
...
.method public bridge synthetic getCues(J)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->getCues(J)Lcom/google/common/collect/y;
...
.method public getEventTime(I)J
    ...
    iget-object v0, p0, Landroidx/media3/extractor/text/CuesWithTimingSubtitle;->eventCues:Lcom/google/common/collect/y;
