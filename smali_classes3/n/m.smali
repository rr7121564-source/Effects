...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln/m;->f:Landroid/content/UriMatcher;
...
.method public constructor <init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1, p2}, Ln/k;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
...
.method private i(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    sget-object v0, Ln/m;->f:Landroid/content/UriMatcher;
    ...
    :cond_0
    invoke-direct {p0, p2, p1}, Ln/m;->j(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
...
.method protected bridge synthetic c(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ln/m;->g(Ljava/io/InputStream;)V
...
.method protected bridge synthetic f(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Ln/m;->h(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
...
.method protected h(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, p1, p2}, Ln/m;->i(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
