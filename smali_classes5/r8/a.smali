...
.method public constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct {p0, v0}, Lr8/b;-><init>(Lkotlin/jvm/internal/j;)V

    iput-object p1, p0, Lr8/a;->a:Ljava/util/Map;

    iput-object p2, p0, Lr8/a;->b:Ljava/util/Map;

    iput-object p3, p0, Lr8/a;->c:Ljava/util/Map;

    iput-object p4, p0, Lr8/a;->d:Ljava/util/Map;

    iput-object p5, p0, Lr8/a;->e:Ljava/util/Map;
...
.method public a(Lr8/d;)V
    ...
    iget-object v0, p0, Lr8/a;->a:Ljava/util/Map;
    ...
    :cond_0
    iget-object v0, p0, Lr8/a;->b:Ljava/util/Map;
    ...
    invoke-static {v3, v2}, Lkotlin/jvm/internal/s;->c(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v5, v2}, Lkotlin/jvm/internal/s;->c(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v4, v6}, Lkotlin/jvm/internal/s;->c(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-interface {p1, v3, v5, v4}, Lr8/d;->b(Lu7/c;Lu7/c;Lk8/b;)V

    goto :goto_1

    :cond_2
    iget-object v0, p0, Lr8/a;->c:Ljava/util/Map;
    ...
    invoke-static {v1, v3}, Lkotlin/jvm/internal/q0;->d(Ljava/lang/Object;I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ln7/l;

    invoke-interface {p1, v4, v1}, Lr8/d;->c(Lu7/c;Ln7/l;)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lr8/a;->e:Ljava/util/Map;
    ...
    invoke-interface {p1, v4, v1}, Lr8/d;->a(Lu7/c;Ln7/l;)V
...
.method public b(Lu7/c;Ljava/util/List;)Lk8/b;
    .locals 1
    ...
    iget-object p2, p0, Lr8/a;->a:Ljava/util/Map;
...
.method public d(Lu7/c;Ljava/lang/String;)Lk8/a;
    .locals 3
    ...
    iget-object v0, p0, Lr8/a;->d:Ljava/util/Map;
    ...
    invoke-static {p1, v0}, Lkotlin/jvm/internal/q0;->i(Ljava/lang/Object;I)Z
...
.method public e(Lu7/c;Ljava/lang/Object;)Lk8/i;
    .locals 3
    ...
    invoke-interface {p1, p2}, Lu7/c;->c(Ljava/lang/Object;)Z
