...
.method public final varargs of([Lokio/ByteString;)Lokio/Options;
    ...
    invoke-direct {v0, v1, v3, v2}, Lokio/Options;-><init>([Lokio/ByteString;[ILkotlin/jvm/internal/j;)V

    return-object v0

    :cond_0
    invoke-static/range {p1 .. p1}, Lb7/i;->i0([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    invoke-static {v1}, Lb7/r;->w(Ljava/util/List;)V
    ...
    invoke-static/range {v5 .. v10}, Lb7/r;->j(Ljava/util/List;Ljava/lang/Comparable;IIILjava/lang/Object;)I
    ...
    invoke-direct {v3, v0, v6, v2}, Lokio/Options;-><init>([Lokio/ByteString;[ILkotlin/jvm/internal/j;)V
