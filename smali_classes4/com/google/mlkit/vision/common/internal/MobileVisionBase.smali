...
.field private final zze:Lj3/b;

.field private final zzf:Ljava/util/concurrent/Executor;

.field private final zzg:Lj3/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zzb:Li2/d;
...
.method public constructor <init>(Lcom/google/mlkit/common/sdkinternal/MLTask;Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zze:Lj3/b;
    ...
    invoke-virtual {p1, p2, v1, v0}, Lcom/google/mlkit/common/sdkinternal/ModelResource;->callAfterLoad(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lj3/a;)Lj3/j;

    move-result-object p1

    sget-object p2, Lcom/google/mlkit/vision/common/internal/zzc;->zza:Lcom/google/mlkit/vision/common/internal/zzc;

    invoke-virtual {p1, p2}, Lj3/j;->d(Lj3/f;)Lj3/j;

    move-result-object p1

    iput-object p1, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zzg:Lj3/j;
...
.method static synthetic zzc(Ljava/lang/Exception;)V
    ...
    sget-object v0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zzb:Li2/d;

    const-string v1, "MobileVisionBase"

    const-string v2, "Error preloading model resource"

    invoke-virtual {v0, v1, v2, p0}, Li2/d;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public declared-synchronized close()V
    ...
    iget-object v0, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zze:Lj3/b;
...
.method public declared-synchronized closeWithTask()Lj3/j;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0, v1}, Lcom/google/mlkit/common/sdkinternal/ModelResource;->unpinWithTask(Ljava/util/concurrent/Executor;)Lj3/j;
...
.method public declared-synchronized getInitTaskBase()Lj3/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zzg:Lj3/j;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public process(Landroid/graphics/Bitmap;I)Lj3/j;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->processBase(Lcom/google/mlkit/vision/common/InputImage;)Lj3/j;
...
.method public process(Landroid/media/Image;I)Lj3/j;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public process(Landroid/media/Image;ILandroid/graphics/Matrix;)Lj3/j;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public process(Ljava/nio/ByteBuffer;IIII)Lj3/j;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public declared-synchronized processBase(Lcom/google/mlkit/vision/common/InputImage;)Lj3/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zze:Lj3/b;

    invoke-virtual {p1}, Lj3/b;->b()Lj3/a;

    move-result-object p1

    invoke-virtual {v0, v1, v2, p1}, Lcom/google/mlkit/common/sdkinternal/ModelResource;->callAfterLoad(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lj3/a;)Lj3/j;
...
.method public declared-synchronized processBase(Ll3/a;)Lj3/j;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Lcom/google/mlkit/vision/common/internal/MobileVisionBase;->zzc:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method final synthetic zza(Lcom/google/mlkit/vision/common/InputImage;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lb3/jb;->f(Ljava/lang/String;)Lb3/jb;

    move-result-object v3

    invoke-virtual {v3}, Lb3/jb;->b()Lb3/jb;
    ...
    invoke-virtual {v3}, Lb3/jb;->close()V
...
.method final synthetic zzb(Ll3/a;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-static {p1}, Lcom/google/mlkit/vision/common/internal/CommonConvertUtils;->convertMlImagetoInputImage(Ll3/a;)Lcom/google/mlkit/vision/common/InputImage;
