...
# virtual methods
.method public callAfterLoad(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lj3/a;)Lj3/j;
    .locals 9
    ...
    invoke-virtual {p3}, Lj3/a;->a()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {}, Lj3/m;->d()Lj3/j;
    ...
    invoke-direct {v6, v0}, Lj3/k;-><init>(Lj3/a;)V

    new-instance v7, Lcom/google/mlkit/common/sdkinternal/zzm;

    invoke-direct {v7, p1, p3, v3, v6}, Lcom/google/mlkit/common/sdkinternal/zzm;-><init>(Ljava/util/concurrent/Executor;Lj3/a;Lj3/b;Lj3/k;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/mlkit/common/sdkinternal/zzn;-><init>(Lcom/google/mlkit/common/sdkinternal/ModelResource;Lj3/a;Lj3/b;Ljava/util/concurrent/Callable;Lj3/k;)V
...
.method public unpin(Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/mlkit/common/sdkinternal/ModelResource;->unpinWithTask(Ljava/util/concurrent/Executor;)Lj3/j;

    return-void
.end method

.method public unpinWithTask(Ljava/util/concurrent/Executor;)Lj3/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v0}, Lcom/google/mlkit/common/sdkinternal/zzl;-><init>(Lcom/google/mlkit/common/sdkinternal/ModelResource;Lj3/k;)V
...
.method final synthetic zza(Lj3/a;Lj3/b;Ljava/util/concurrent/Callable;Lj3/k;)V
    .locals 3
    ...
    :cond_3
    invoke-virtual {p4, p3}, Lj3/k;->c(Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-virtual {p4, p3}, Lj3/k;->b(Ljava/lang/Exception;)V

    return-void
.end method

.method final synthetic zzb(Lj3/k;)V
    .locals 3
    ...
    :cond_1
    invoke-static {}, Lz2/jh;->a()V

    const/4 v0, 0x1

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lj3/k;->c(Ljava/lang/Object;)V
