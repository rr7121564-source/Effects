...
# instance fields
.field private final resultTaskCompletionSource:Lj3/k;
...
# direct methods
.method public constructor <init>(Lcom/google/firebase/installations/Utils;Lj3/k;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:Lj3/k;
...
.method public onException(Ljava/lang/Exception;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:Lj3/k;
...
.method public onStateReached(Lcom/google/firebase/installations/local/PersistedInstallationEntry;)Z
    ...
    invoke-virtual {v0, p1}, Lj3/k;->c(Ljava/lang/Object;)V
