...
.field private static final SETTINGS_URL_FORMAT:Ljava/lang/String; = "127.0.0.1"
...
.method public getSettingsAsync()Lj3/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public loadSettingsData(Lcom/google/firebase/crashlytics/internal/settings/SettingsCacheBehavior;Ljava/util/concurrent/Executor;)Lj3/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lj3/k;->e(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1, p2}, Lcom/google/firebase/crashlytics/internal/common/DataCollectionArbiter;->waitForDataCollectionPermission(Ljava/util/concurrent/Executor;)Lj3/j;
    ...
    invoke-virtual {p1, p2, v0}, Lj3/j;->r(Ljava/util/concurrent/Executor;Lj3/i;)Lj3/j;
...
.method public loadSettingsData(Ljava/util/concurrent/Executor;)Lj3/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/firebase/crashlytics/internal/settings/SettingsController;->loadSettingsData(Lcom/google/firebase/crashlytics/internal/settings/SettingsCacheBehavior;Ljava/util/concurrent/Executor;)Lj3/j;
