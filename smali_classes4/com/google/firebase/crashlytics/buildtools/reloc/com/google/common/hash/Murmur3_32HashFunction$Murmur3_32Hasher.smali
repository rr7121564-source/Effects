...
.method constructor <init>(I)V
    ...
    iput p1, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->length:I

    iput-boolean p1, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->isDone:Z
...
.method private update(IJ)V
    ...
    iget v2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->shift:I

    shl-long/2addr p2, v2

    or-long/2addr p2, v0

    iput-wide p2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->buffer:J

    mul-int/lit8 v0, p1, 0x8

    add-int/2addr v2, v0

    iput v2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->shift:I
    ...
    invoke-static {p2}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction;->access$000(I)I

    move-result p2

    invoke-static {v0, p2}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction;->access$100(II)I

    move-result p2

    iput p2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->h1:I

    iget-wide p2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->buffer:J

    ushr-long/2addr p2, p1

    iput-wide p2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->buffer:J

    iget p2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->shift:I

    sub-int/2addr p2, p1

    iput p2, p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->shift:I
...
.method public putByte(B)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Hasher;
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->update(IJ)V
...
.method public putBytes([BII)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Hasher;
    ...
    invoke-static {p1, v0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction;->access$200([BI)I
    ...
    invoke-direct {p0, v0, v2, v3}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->update(IJ)V
...
.method public putLong(J)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Hasher;
    ...
    invoke-direct {p0, v2, p1, p2}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->update(IJ)V
...
.method public putString(Ljava/lang/CharSequence;Ljava/nio/charset/Charset;)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Hasher;
    ...
    invoke-direct {p0, v3, v4, v5}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->update(IJ)V
    ...
    invoke-direct {p0, v2, v6, v7}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->update(IJ)V
    ...
    invoke-direct {p0, v3, v6, v7}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/Murmur3_32HashFunction$Murmur3_32Hasher;->update(IJ)V
