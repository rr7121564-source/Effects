...
.method public static coerceToInteger(Ljava/net/InetAddress;)I
    ...
    invoke-static {p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteStreams;->newDataInput([B)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteArrayDataInput;

    move-result-object p0

    invoke-interface {p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteArrayDataInput;->readInt()I
...
.method public static fromInteger(I)Ljava/net/Inet4Address;
    ...
    invoke-static {p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->getInet4Address([B)Ljava/net/Inet4Address;
...
.method public static getCoercedIPv4Address(Ljava/net/InetAddress;)Ljava/net/Inet4Address;
    ...
    sget-object p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->LOOPBACK4:Ljava/net/Inet4Address;
    ...
    sget-object p0, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->ANY4:Ljava/net/Inet4Address;
    ...
    invoke-static {p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->hasEmbeddedIPv4ClientAddress(Ljava/net/Inet6Address;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->getEmbeddedIPv4ClientAddress(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    invoke-interface {p0, v0, v1}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/HashFunction;->hashLong(J)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/hash/HashCode;
...
.method public static getEmbeddedIPv4ClientAddress(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    invoke-virtual {p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses$TeredoInfo;->getClient()Ljava/net/Inet4Address;
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->formatIllegalArgumentException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/IllegalArgumentException;
...
.method public static getTeredoInfo(Ljava/net/Inet6Address;)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses$TeredoInfo;
    ...
    invoke-static {p0, v1}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteStreams;->newDataInput([BI)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteArrayDataInput;

    move-result-object v1

    invoke-interface {v1}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteArrayDataInput;->readShort()S
    ...
    invoke-static {p0, v3}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteStreams;->newDataInput([BI)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteArrayDataInput;

    move-result-object v3

    invoke-interface {v3}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/io/ByteArrayDataInput;->readShort()S
    ...
    new-instance v3, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses$TeredoInfo;

    invoke-direct {v3, v0, p0, v2, v1}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses$TeredoInfo;-><init>(Ljava/net/Inet4Address;Ljava/net/Inet4Address;II)V
...
.method private static textToNumericFormatV4(Ljava/lang/String;)[B
    ...
    :try_start_0
    sget-object v3, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->IPV4_SPLITTER:Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/base/Splitter;

    invoke-virtual {v3, p0}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/base/Splitter;->split(Ljava/lang/CharSequence;)Ljava/lang/Iterable;
    ...
    invoke-static {v4}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->parseOctet(Ljava/lang/String;)B
...
.method private static textToNumericFormatV6(Ljava/lang/String;)[B
    ...
    invoke-static {v7}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->parseHextet(Ljava/lang/String;)S
    ...
    invoke-static {v1}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/net/InetAddresses;->parseHextet(Ljava/lang/String;)S
...
.method public static toAddrString(Ljava/net/InetAddress;)Ljava/lang/String;
    ...
    invoke-static {v2, v2, v5, v4}, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/primitives/Ints;->fromBytes(BBBB)I
