...
.method public constructor <init>(Landroid/content/Context;Lb5/k;)V
    ...
    iput-object p2, p0, La5/l1;->p:Lb5/k;

    invoke-direct {p0}, La5/l1;->c()V

    return-void
.end method

.method static synthetic a(La5/l1;)Lb5/k;
    .locals 0

    iget-object p0, p0, La5/l1;->p:Lb5/k;
...
.method private c()V
    ...
    iput-object v0, p0, La5/l1;->i:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseValue;
    ...
    iput-object v0, p0, La5/l1;->f:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseColor;
    ...
    iput-object v0, p0, La5/l1;->g:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseColor;
    ...
    iput-object v0, p0, La5/l1;->o:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseFont;
    ...
    iput-object v0, p0, La5/l1;->z:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetBgDemo;
    ...
    iput-object v0, p0, La5/l1;->j:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseValue;
    ...
    iput-object v0, p0, La5/l1;->b:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;
    ...
    iput-object v0, p0, La5/l1;->c:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;
    ...
    iput-object v0, p0, La5/l1;->d:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;

    iget-object v0, p0, La5/l1;->z:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetBgDemo;

    new-instance v1, La5/l1$a;

    invoke-direct {v1, p0}, La5/l1$a;-><init>(La5/l1;)V
    ...
    iget-object v0, p0, La5/l1;->i:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseValue;
    ...
    const-string v2, "HAWK_TEXT_SIZE_FIXED"
    ...
    new-instance v2, La5/l1$b;

    invoke-direct {v2, p0}, La5/l1$b;-><init>(La5/l1;)V
    ...
    iget-object v0, p0, La5/l1;->j:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseValue;
    ...
    sget-object v2, Lcom/orhanobut/hawk/ZAjR/styoLRqpzKan;->FoTHzpMbrBM:Ljava/lang/String;
    ...
    new-instance v2, La5/l1$c;

    invoke-direct {v2, p0}, La5/l1$c;-><init>(La5/l1;)V

    const/16 v3, 0xff

    invoke-virtual {v0, v4, v3, v1, v2}, Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseValue;->h(IIILcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseValue$b;)V

    iget-object v0, p0, La5/l1;->f:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseColor;
    ...
    const-string v2, "HAWK_TEXT_COLOR_FIXED"
    ...
    new-instance v2, La5/l1$d;

    invoke-direct {v2, p0}, La5/l1$d;-><init>(La5/l1;)V
    ...
    iget-object v0, p0, La5/l1;->g:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseColor;
    ...
    new-instance v2, La5/l1$e;

    invoke-direct {v2, p0}, La5/l1$e;-><init>(La5/l1;)V

    invoke-virtual {v0, v1, v2}, Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseColor;->c(ILcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseColor$b;)V

    iget-object v0, p0, La5/l1;->b:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;
    ...
    new-instance v3, La5/l1$f;

    invoke-direct {v3, p0}, La5/l1$f;-><init>(La5/l1;)V
    ...
    iget-object v0, p0, La5/l1;->c:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;

    const-string v2, "HAWK_HIDE_BORDER_FIXED"
    ...
    new-instance v3, La5/l1$g;

    invoke-direct {v3, p0}, La5/l1$g;-><init>(La5/l1;)V

    invoke-virtual {v0, v2, v3}, Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;->e(ZLcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch$b;)V

    iget-object v0, p0, La5/l1;->o:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetChooseFont;
    ...
    new-instance v3, La5/l1$h;

    invoke-direct {v3, p0}, La5/l1$h;-><init>(La5/l1;)V
    ...
    iget-object v0, p0, La5/l1;->d:Lcom/recognize_text/translate/screen/domain/widgets/widget_main/WidgetSwitch;

    const-string v2, "HAWK_SPEAK_AFTER_TRANSLATION"
    ...
    new-instance v2, La5/l1$i;

    invoke-direct {v2, p0}, La5/l1$i;-><init>(La5/l1;)V
