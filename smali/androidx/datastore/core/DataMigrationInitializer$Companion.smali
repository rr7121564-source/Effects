...
.method public static final synthetic access$runMigrations(Landroidx/datastore/core/DataMigrationInitializer$Companion;Ljava/util/List;Landroidx/datastore/core/InitializerApi;Le7/e;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/datastore/core/DataMigrationInitializer$Companion;->runMigrations(Ljava/util/List;Landroidx/datastore/core/InitializerApi;Le7/e;)Ljava/lang/Object;
...
.method private final runMigrations(Ljava/util/List;Landroidx/datastore/core/InitializerApi;Le7/e;)Ljava/lang/Object;
    .locals 6
    ...
    invoke-direct {v0, p0, p3}, Landroidx/datastore/core/DataMigrationInitializer$Companion$runMigrations$1;-><init>(Landroidx/datastore/core/DataMigrationInitializer$Companion;Le7/e;)V
    ...
    check-cast p2, Lkotlin/jvm/internal/k0;
    ...
    invoke-direct {v2, p1, p3, v5}, Landroidx/datastore/core/DataMigrationInitializer$Companion$runMigrations$2;-><init>(Ljava/util/List;Ljava/util/List;Le7/e;)V
    ...
    invoke-interface {p2, v2, v0}, Landroidx/datastore/core/InitializerApi;->updateData(Ln7/p;Le7/e;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v0}, Ln7/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_3
    iget-object v2, p2, Lkotlin/jvm/internal/k0;->b:Ljava/lang/Object;

    if-nez v2, :cond_6

    iput-object p3, p2, Lkotlin/jvm/internal/k0;->b:Ljava/lang/Object;
    ...
    invoke-static {v2, p3}, La7/e;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V

    goto :goto_2

    :cond_7
    iget-object p1, p2, Lkotlin/jvm/internal/k0;->b:Ljava/lang/Object;
...
# virtual methods
.method public final getInitializer(Ljava/util/List;)Ln7/p;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p1, v1}, Landroidx/datastore/core/DataMigrationInitializer$Companion$getInitializer$1;-><init>(Ljava/util/List;Le7/e;)V
