...
.method public static synthetic a(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public static synthetic b(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
    .locals 0
...
.method public static synthetic c(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;->lambda$preCapture$10(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method public static synthetic d(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;->lambda$preCapture$8(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method public static synthetic e(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;->lambda$preCapture$6(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method public static synthetic g(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic i(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic j(Landroid/hardware/camera2/TotalCaptureResult;)Z
    .locals 0
...
.method public static synthetic k(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic l(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;->lambda$preCapture$4(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method private static synthetic lambda$preCapture$1(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, Landroidx/camera/camera2/internal/r1;-><init>(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$preCapture$10(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private synthetic lambda$preCapture$3(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/camera2/internal/p1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$preCapture$4(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p1, v0}, Landroidx/camera/camera2/internal/FocusMeteringControl;->enableExternalFlashAeMode(Z)Lcom/google/common/util/concurrent/m;
...
.method private synthetic lambda$preCapture$5(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v3}, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->enableTorchInternal(I)V
...
.method private synthetic lambda$preCapture$6(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {p1, p0}, Landroidx/camera/camera2/internal/k1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;)V
...
.method private synthetic lambda$preCapture$7(Lcom/google/common/util/concurrent/m;Ljava/lang/Object;)Lcom/google/common/util/concurrent/m;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-static/range {v2 .. v7}, Landroidx/camera/core/impl/utils/futures/Futures;->makeTimeoutFuture(JLjava/util/concurrent/ScheduledExecutorService;Ljava/lang/Object;ZLcom/google/common/util/concurrent/m;)Lcom/google/common/util/concurrent/m;
...
.method private synthetic lambda$preCapture$8(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p1}, Landroidx/camera/camera2/internal/FocusMeteringControl;->triggerAePrecapture()Lcom/google/common/util/concurrent/m;
...
.method public static synthetic m(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Lcom/google/common/util/concurrent/m;Ljava/lang/Object;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;->lambda$preCapture$7(Lcom/google/common/util/concurrent/m;Ljava/lang/Object;)Lcom/google/common/util/concurrent/m;
...
.method public postCapture()V
    ...
    invoke-virtual {v0, v1}, Landroidx/camera/camera2/internal/FocusMeteringControl;->enableExternalFlashAeMode(Z)Lcom/google/common/util/concurrent/m;

    move-result-object v0

    new-instance v2, Landroidx/camera/camera2/internal/n1;

    invoke-direct {v2}, Landroidx/camera/camera2/internal/n1;-><init>()V
    ...
    invoke-direct {v2, v1}, Landroidx/camera/camera2/internal/o1;-><init>(Landroidx/camera/core/ImageCapture$ScreenFlash;)V
...
.method public preCapture(Landroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/m;
    .locals 3
    ...
    invoke-direct {v0, p1}, Landroidx/camera/camera2/internal/s1;-><init>(Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    invoke-direct {v1, p0, p1}, Landroidx/camera/camera2/internal/t1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/u1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;)V
    ...
    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/v1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;)V
    ...
    invoke-direct {v1, p0, v0}, Landroidx/camera/camera2/internal/w1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;Lcom/google/common/util/concurrent/m;)V
    ...
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/x1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;)V
    ...
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/l1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$ScreenFlashTask;)V
    ...
    invoke-direct {v0}, Landroidx/camera/camera2/internal/m1;-><init>()V
