...
.method public static synthetic a(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;->lambda$preCapture$1(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method public static synthetic c(Landroid/hardware/camera2/TotalCaptureResult;)Z
    ...
    invoke-static {p0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;->lambda$preCapture$2(Landroid/hardware/camera2/TotalCaptureResult;)Z
...
.method public static synthetic d(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;->lambda$preCapture$4(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
...
.method public static synthetic e(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;->lambda$preCapture$3(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method private synthetic lambda$preCapture$1(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private static synthetic lambda$preCapture$2(Landroid/hardware/camera2/TotalCaptureResult;)Z
    .locals 1
...
.method private synthetic lambda$preCapture$3(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    new-instance v3, Landroidx/camera/camera2/internal/y1;

    invoke-direct {v3}, Landroidx/camera/camera2/internal/y1;-><init>()V
...
.method private static synthetic lambda$preCapture$4(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
    .locals 0
...
.method public preCapture(Landroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/m;
    ...
    invoke-direct {p1, p0}, Landroidx/camera/camera2/internal/z1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;)V
    ...
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/a2;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;)V
    ...
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/b2;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;)V
    ...
    invoke-direct {v0}, Landroidx/camera/camera2/internal/c2;-><init>()V
