...
.method constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;Lp3/p;Z)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p10, p0, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lp3/p;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {v0, v1, v2, p2}, Landroidx/media3/datasource/w;->a(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    iget v0, p0, Landroidx/media3/datasource/HttpEngineDataSource;->requestPriority:I

    invoke-static {p2, v0}, Landroidx/media3/datasource/x;->a(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    const/4 v0, 0x1

    invoke-static {p2, v0}, Landroidx/media3/datasource/y;->a(Landroid/net/http/UrlRequest$Builder;Z)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v3, v2}, Landroidx/media3/datasource/z;->a(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v1, v0}, Landroidx/media3/datasource/z;->a(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/a0;->a(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0, p1}, Landroidx/media3/datasource/m;->a(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)Landroid/net/http/UrlRequest$Builder;
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    invoke-static {p1}, Landroidx/media3/datasource/n;->a(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    invoke-static {p0}, Landroidx/media3/datasource/t;->a(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p0

    invoke-static {p0}, Landroidx/media3/datasource/u;->a(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method public getResponseCode()I
    ...
    invoke-static {v0}, Landroidx/media3/datasource/l;->a(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/media3/datasource/t;->a(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/datasource/o;->a(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    invoke-static {v2}, Lp3/c;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Landroidx/media3/datasource/p;->a(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    invoke-static {v4}, Landroidx/media3/datasource/o;->a(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    :cond_2
    iget-object v12, v1, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lp3/p;
    ...
    invoke-interface {v12, v13}, Lp3/p;->apply(Ljava/lang/Object;)Z
