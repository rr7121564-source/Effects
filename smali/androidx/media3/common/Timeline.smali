...
.method public static fromBundle(Landroid/os/Bundle;)Landroidx/media3/common/Timeline;
    ...
    invoke-direct {v0}, Landroidx/media3/common/h3;-><init>()V
    ...
    invoke-static {v0, v1}, Landroidx/media3/common/Timeline;->fromBundleListRetriever(Lp3/g;Landroid/os/IBinder;)Lcom/google/common/collect/y;

    move-result-object v0

    new-instance v1, Landroidx/media3/common/i3;

    invoke-direct {v1}, Landroidx/media3/common/i3;-><init>()V
    ...
    invoke-static {v1, v2}, Landroidx/media3/common/Timeline;->fromBundleListRetriever(Lp3/g;Landroid/os/IBinder;)Lcom/google/common/collect/y;
    ...
    :cond_0
    invoke-direct {v2, v0, v1, p0}, Landroidx/media3/common/Timeline$RemotableTimeline;-><init>(Lcom/google/common/collect/y;Lcom/google/common/collect/y;[I)V

    return-object v2
.end method

.method private static fromBundleListRetriever(Lp3/g;Landroid/os/IBinder;)Lcom/google/common/collect/y;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_0
    invoke-static {p1}, Landroidx/media3/common/BundleListRetriever;->getList(Landroid/os/IBinder;)Lcom/google/common/collect/y;

    move-result-object p1

    invoke-static {p0, p1}, Landroidx/media3/common/util/BundleCollectionUtil;->fromBundleList(Lp3/g;Ljava/util/List;)Lcom/google/common/collect/y;
...
.method public final copyWithSingleWindow(I)Landroidx/media3/common/Timeline;
    ...
    invoke-direct {v1, p1, v0, v2}, Landroidx/media3/common/Timeline$RemotableTimeline;-><init>(Lcom/google/common/collect/y;Lcom/google/common/collect/y;[I)V
