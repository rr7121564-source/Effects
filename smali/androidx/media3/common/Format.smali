...
.method private constructor <init>(Landroidx/media3/common/Format$Builder;)V
    ...
    invoke-static {v0}, Landroidx/media3/common/m;->a(Ljava/util/List;)Ljava/util/stream/Stream;

    move-result-object v0

    new-instance v1, Landroidx/media3/common/s;

    invoke-direct {v1, p1}, Landroidx/media3/common/s;-><init>(Landroidx/media3/common/Format$Builder;)V

    invoke-static {v0, v1}, Landroidx/media3/common/n;->a(Ljava/util/stream/Stream;Ljava/util/function/Predicate;)Z
...
.method public static fromBundle(Landroid/os/Bundle;)Landroidx/media3/common/Format;
    ...
    invoke-static {v3, v1}, Landroidx/media3/common/util/BundleCollectionUtil;->fromBundleList(Lp3/g;Ljava/util/List;)Lcom/google/common/collect/y;
...
.method public static toLogString(Landroidx/media3/common/Format;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lp3/h;->f(C)Lp3/h;

    move-result-object v4

    invoke-virtual {v4, v0, v1}, Lp3/h;->b(Ljava/lang/StringBuilder;Ljava/lang/Iterable;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v1, v0, v4}, Lp3/h;->b(Ljava/lang/StringBuilder;Ljava/lang/Iterable;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v1, v0, p0}, Lp3/h;->b(Ljava/lang/StringBuilder;Ljava/lang/Iterable;)Ljava/lang/StringBuilder;
...
.method public toBundle(Z)Landroid/os/Bundle;
    ...
    new-instance v3, Landroidx/media3/common/q;

    invoke-direct {v3}, Landroidx/media3/common/q;-><init>()V
